...
//
// Arguments:
// - fin:       Reference to the ifstream of the music file.
// - id3_pos:   The std::streampos of the ID3 tag in the music file.
...
// Accepts an ifstream past the ID3 header, scans ID3 frames and writes them to JSON.
//
// Arguments:
