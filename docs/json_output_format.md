...
<div style="display: flex; justify-content: space-between;">
    <span>
        ...
        <code>></code> 
        <a href="{{ site.baseurl }}/json_output_format.html">JSON Output Format</a>
    </span>
...
The `"meta"` block contains the metadata of the snapshot.
...
a long string of text under key `"picture_data"`. `"APIC"` is an
array containing all the APIC frames found in the song.
```json
"APIC": [
  {
    "description": "",
